...
function seleccionarHora() {
    ...
    inputHora.addEventListener('input', function (e) {
        ...
        if ((hora >= 9 && hora < 14) || (hora > 17 && hora < 20)) {
...
async function reservarCita() {
    ...
    try {
        ...
        const url = 'https://bluevelvet.herokuapp.com/api/citas';
        ...
        Swal.close();
        //{resultado: true, id: 1}
        //{resultado: 'Ya existe una cita para este usuario'}

        //si se crea una cita correctamente devuelve un objeto con un id, si ya existe una cita para el usuario devuelve un string
